...
<div class="box">
    ...
    <?php if ($system_edition) : ?>
        <a class='btn btn-primary' href="Daemon/editConfig">
...
<div class="box">
    ...
    <?php $this->suivantPrecedent($offset, 20, count($entity_list), "Daemon/config?search=$search"); ?>
        ...
        <table class="table table-striped">
            ...
            <?php foreach ($entity_list as $entity) : ?>
                <tr>
                    ...
                    <td>
                        <?php if ($entity['id_daemon'] !== null && $entity['id_daemon'] !== 1) : ?>
